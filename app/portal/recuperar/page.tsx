    ...
    <main className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm rounded-2xl border border-line bg-card p-8">
        <div className="mb-6 text-center">
          ...
          <p className="mt-1 text-sm text-muted">Portal Mayorista · Bodysculpt</p>
        </div>
        ...
        <p className="mt-5 text-center text-sm text-muted">
          <Link href="/portal/login" className="font-medium text-accent hover:underline">Volver al ingreso</Link>
        </p>
      </div>
    </main>
  );
