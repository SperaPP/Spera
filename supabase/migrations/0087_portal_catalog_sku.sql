-- 0087_portal_catalog_sku.sql — el catálogo del portal expone un SKU por producto.
--
-- Agrega `sku` (bigint) a portal_catalog_all: el mayor SKU numérico entre las
-- variantes del producto. Sirve para ordenar el catálogo de mayor a menor SKU
-- (lo más nuevo primero). Se dropea la firma previa para recrear con la columna
-- nueva. Retrocompatible: el código viejo ignora la columna extra.
